...
and [copyrights and citations](https://courses.cs.washington.edu/courses/cse154/20au/index.html#copyright). If we find plagiarism in CPs or inappropriate content, **you will be ineligible for any points on the CP**. Ask the instructor if you're unsure if your work is appropriate/correctly cited.
